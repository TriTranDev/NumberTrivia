...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      test(
          'should return remote data when the call to remote data source is successdull',
          () async {
      ...
      test(
          'should cache the data localy when call to remote data source is successfull',
          () async {
        when(mockRemoteDataSource.getConcreteNumberTrivia(tNumber))
            .thenAnswer((_) async => tNumberTriviaModel);

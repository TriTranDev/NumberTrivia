...
// in trivial_number/test/features/number_trivia/presentation/bloc/number_trivia_bloc_test.dart.
...
import 'package:trivial_number/core/error/failures.dart' as _i5;
import 'package:trivial_number/core/usecases/usecases.dart' as _i10;
import 'package:trivial_number/core/util/input_converter.dart' as _i4;
...
/// A class which mocks [GetRandomNumberTriviaFun].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetRandomNumberTriviaFun extends _i1.Mock
    implements _i9.GetRandomNumberTriviaFun {
  @override
  _i3.NumberTriviaRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
              returnValue: _FakeNumberTriviaRepository_1())
